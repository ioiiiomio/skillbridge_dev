...
export function PartnerCategoryCard({
    ...
    return (
        <div className="group flex h-full min-w-0 flex-col rounded-2xl border border-white/70 bg-white/90 p-6 shadow-glass backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:bg-white sm:p-7">
